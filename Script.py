...
📌 ꜰᴏʀ ꜱᴇʀɪᴇꜱ:  
➤ ᴍᴏᴠɪᴇ ɴᴀᴍᴇ + S01 (ꜰᴏʀ ꜱᴇᴀꜱᴏɴ 1, ᴄʜᴀɴɢᴇ ꜰᴏʀ ᴏᴛʜᴇʀꜱ)  
...
<b>ʀᴇǫ ʙʏ : {message.from_user.mention}</b>"""
    ...
    LOGO = r"""
    Bot Started Successfully Now Click on the start button
...
ɪꜰ ʏᴏᴜ ꜰᴀᴄᴇ ᴀɴʏ ᴘʀᴏʙʟᴇᴍ, ᴛᴀᴋᴇ ᴀ ꜱᴄʀᴇᴇɴꜱʜᴏᴛ ᴀɴᴅ ꜱᴇɴᴅ ɪᴛ ᴛᴏ - @HP_Raj_Support_Bot
...
ꜱᴏᴜʀᴄᴇ ᴄᴏᴅᴇ ʜᴇʀᴇ ◉› :<a href='https://t.me/HP_Raj_MOVIES'>ӇƤ Ʀƛʆ</a>\n """
...
✅ ʏᴏᴜʀ ɴᴇᴡ ᴛᴏᴋᴇɴ ɪs sᴜᴄᴄᴇssғᴜʟʟʏ ɢᴇɴᴇʀᴀᴛᴇᴅ.✅ 
 ...
 Nᴏᴡ ʏᴏᴜ ᴄᴀɴ ᴜsᴇ ᴍᴇ ɪɴ ᴛʜᴇ ɴᴇxᴛ 24 ʜᴏᴜʀs.
