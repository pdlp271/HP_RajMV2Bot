...
PREMIUM_LOGS = int(environ.get('PREMIUM_LOGS', '-1002701898228'))  # Premium logs channel id
DELETE_CHANNELS = [int(dch) if id_pattern.search(dch) else dch for dch in environ.get('DELETE_CHANNELS', '-1002691497570').split()] #(make sure bot is admin)
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1002896067356')  # Support group id (make sure bot is admin)
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1002355254553')  # Request channel id (make sure bot is admin)
...
auth_channels     = environ.get("AUTH_CHANNELS", "-1002647662043,-1002868754706")# Channels for force sub (make sure bot is admin)
...
TMDB_API_KEY = environ.get('TMDB_API_KEY', '3cd73a23dc3380fa5428a2878260cd77') # preffer to use your own tmdb API Key get it from https://www.themoviedb.org/settings/api
...
VERIFY_IMG = environ.get("VERIFY_IMG", "https://i.ibb.co/skq1Wyn/x.jpg")
...
SHORTENER_API = environ.get("SHORTENER_API", "7f4785525dda19ff748e7f92f1ad4fc7cac85a43") # Shortener API key
SHORTENER_WEBSITE = environ.get("SHORTENER_WEBSITE", "Shortxlinks.com") # Shortener website

SHORTENER_API2 = environ.get("SHORTENER_API2", "7f4785525dda19ff748e7f92f1ad4fc7cac85a43")  # Shortener API key for second website
SHORTENER_WEBSITE2 = environ.get("SHORTENER_WEBSITE2", "Shortxlinks.com") # Shortener website for second website

SHORTENER_API3 = environ.get("SHORTENER_API3", "7f4785525dda19ff748e7f92f1ad4fc7cac85a43")  
...
UPDATE_CHNL_LNK = environ.get('UPDATE_CHNL_LNK', 'https://t.me/+DdA9O8bwZ0ljODk1') # Update channel link for the bot
...
MSG_ALRT = environ.get('MSG_ALRT', 'I Am HP Raj 💯') # Alert message for users
